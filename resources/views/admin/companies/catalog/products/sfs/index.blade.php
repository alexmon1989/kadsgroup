...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            <p>
                <a class="btn btn-primary" href="{{ action('Admin\Companies\Catalog\Products\SfsController@getCreate') }}"><i class="fa fa-plus"></i> Создать</a>
            </p>
...
<script>
    $(function() {
        $('#data-products').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('datatables.sfs.data') !!}',
            columns: [
                { data: 'id', name: 'id' },
