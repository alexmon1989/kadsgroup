...
@section('top_content')
    @include('admin.layout.breadcrumbs', [
                ...
                'items' => [
                        ...
                        [ 'title' => 'Редактирование группы категорий '.$group_category->title, 'action' => '', 'active' => TRUE ],
                ]
            ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{{ 'Редактирование группы категорий '.$group_category->title }}</h3>
