...
@section('top_content')
    @include('admin.layout.breadcrumbs', [
                ...
                'items' => [
                        ...
                        [ 'title' => 'Редактирование настроек каталога', 'action' => '', 'active' => TRUE ],
                ]
            ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{{ 'Редактирование настроек каталога' }}</h3>
    ...
    <div class="box-body">
        @include('admin.companies.catalog.settings._form')
    </div><!-- /.box-body -->
