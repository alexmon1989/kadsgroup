<form role="form" method="post" enctype="multipart/form-data">
    ...
    <div class="box-body">
        <div class="form-group">
            <label for="thumbnail">Изображение фоновое</label>
        ...
        <div class="form-group">
            <label for="title">Текст 1</label>
            <input type="text" placeholder="Текст 1" id="text_1" name="text_1" class="form-control" value="{{ old('text_1', isset($slider) ? $slider->text_1 : '') }}">
        </div>
        <div class="form-group">
            <label for="title">Текст 2</label>
            <input type="text" placeholder="Текст 2" id="text_1" name="text_2" class="form-control" value="{{ old('text_2', isset($slider) ? $slider->text_2 : '') }}">
        </div>
        <div class="form-group">
            <label for="preview_text_mid">css_main</label>
        ...
        <div class="form-group">
            <label for="preview_text_mid">css_1</label>
            <textarea id="css_main" name="css_1" class="form-control">{{ old('css_1', isset($slider) ? $slider->css_1 : config('slider.default.css_1')) }}</textarea>
            <p class="help-block">Меняйте значение этого поля только если знаете что делаете!</p>
        </div>
        <div class="form-group">
            <label for="preview_text_mid">css_2</label>
            <textarea id="css_main" name="css_2" class="form-control">{{ old('css_2', isset($slider) ? $slider->css_2 : config('slider.default.css_2')) }}</textarea>
            <p class="help-block">Меняйте значение этого поля только если знаете что делаете!</p>
        </div>
        <div class="form-group">
