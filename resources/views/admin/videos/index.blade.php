...
@include('admin.layout.breadcrumbs', [
            ...
            'items' => array(
                    ...
                    array('title' => 'Видео', 'action' => '', 'active' => TRUE),
            )
        ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Управление видео</h3>
    ...
    <div class="box-body">
        ...
        <table id="data" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            @foreach($videos as $item)
                <tr>
                    <td>{{ $item->id }}</td>
                    <td><a href="https://www.youtube.com/watch?v={{ $item->youtube_id }}" target="_blank" title="Открыть в новой вкладке">https://www.youtube.com/watch?v={{ $item->youtube_id }}</a></td>
