...
@include('admin.layout.breadcrumbs', [
            ...
            'items' => [
                    ...
                    ['title' => 'Создание объекта', 'action' => '', 'active' => TRUE],
            ]
        ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Создание объекта</h3>
    ...
    <div class="box-body">
        <a href="{{ action('Admin\ProjectsController@getIndex') }}">Назад ко всем объектам</a>
