...
@section('top_content')
    ...
    @include('marketing.layout.breadcrumbs', [
                ...
                'items' => [
                        ...
                        $category->parent_category ? [ 'title' => $category->parent_category->title, 'action' => 'Marketing\Companies\Sika\CatalogController@getIndex', 'action_params' => ['id' => $category->parent_category->id], 'active' => FALSE ] : null,
    ...
    <div class="col-md-9">
        ...
        @else
            ...
            <ul>
                ...
                <li><a class="text-primary" href="{{ action('Marketing\Companies\Sika\CatalogController@getIndex', ['id' => $childCategory->id]) }}">{{ $childCategory->title }}</a></li>
                @endforeach
            </ul>
        @endif
    </div>
