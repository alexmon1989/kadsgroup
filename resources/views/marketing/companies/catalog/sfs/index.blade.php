...
@section('top_content')
    ...
    @include('marketing.layout.breadcrumbs', [
                ...
                'items' => [
                        ...
                        $category->parent_category ? [ 'title' => $category->parent_category->title, 'action' => 'Marketing\Companies\Sfs\CatalogController@getIndex', 'action_params' => ['id' => $category->parent_category->id], 'active' => FALSE ] : null,
        ...
        @else
            ...
            <ul>
                @foreach($category->child_categories as $childCategory)
                    <li><a class="text-primary" href="{{ action('Marketing\Companies\Sfs\CatalogController@getIndex', ['id' => $childCategory->id]) }}">{{ $childCategory->title }}</a></li>
                @endforeach
            </ul>
        @endif
    </div>
